...
public class CustomService extends ICustomService.Stub {
    ...
    private static final String PROP_LED_RED_TRIGGER = "persist.sys.ext_led_control";

    private static final String SYS_LED_WHITE_TRIGGER = "/sys/class/leds/white_led/trigger";
    private static final String SYS_LED_RED_TRIGGER = "/sys/class/leds/ext_led/trigger";
...
//        return getSystemPropertiesInt(PROP_FAN_INDEX, 0);
    ...
    public void installPackage(String zipPath) {
        ...
        Intent otaIntent = new Intent("com.rk.action.OTA_UPDATE");
        otaIntent.putExtra("path", zipPath);
        otaIntent.setPackage("android.rockchip.update.service");
